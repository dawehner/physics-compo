...
void integration_euler(listv2d& r, listv2d& v, listv2d& a, const listdouble& m, double h, int ti);
void integration_heun(listv2d& r, listv2d& v, listv2d& a, const listdouble& m, double h, int ti);
void integration_rk4(listv2d& r, listv2d& v, listv2d& a, const listdouble& m, double h, int ti);
